# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-04-05 06:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.TextField(blank=True, default='email', max_length=200, null=True)),
            ],
            options={
                'db_table': 'profile',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_pic', models.ImageField(blank=True, null=True, upload_to='picture/')),
                ('description', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='news.Image')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='news.Project')),
        ...
        migrations.AddField(
            model_name='profile',
            name='project',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='news.Project'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
        ...
        migrations.AddField(
            model_name='image',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='news.Location'),
        ),
        migrations.AddField(
            model_name='image',
            name='tags',
